...
function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(getTranslate('AUTH_ERROR'));
        } finally {
            setLoading(false);
        }
    };
                ...
                <div className="card shadow-sm border-0 auth-card">
                    <div className="card-body p-4 p-md-5">
                        ...
                        <div className="text-center mb-4">
                            <div className="auth-icon-circle bg-primary text-white mb-3">
                                <FiLogIn size={28} />
                            </div>
                            <h2 className="fw-bold h4">{getTranslate('loginTitle')}</h2>
                        </div>

                        <form onSubmit={handleSubmit}>
                            <div className="mb-3">
                                <label className="form-label small fw-semibold text-muted">
                                    {getTranslate('emailLabel')}
                                </label>
